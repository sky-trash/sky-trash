...
- Разработал и внедрил 3 новых микросервиса на **Laravel**, что позволило масштабировать функционал продукта.
...
- Интегрировал фронтенд с FastAPI, активно взаимодействуя с бэкенд-разработчиками.
- **Стек:** Vue.js, JavaScript, SCSS, FastAPI, Git.
